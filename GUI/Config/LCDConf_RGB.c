...
设置图层1和图层2对应的显存地址
      ...
      这里为了方便起见，将开发板配套的32MB的SDRAM前8MB分配给LCD显存使用，后8MB用于emWin动态内存。
...
注意mlloc.h和malloc.c中的外部SDRAM内存管理池地址和大小也需要做修改！！！！	  
*/
...
static void Color2IndexBulk_##PFIX##_DMA2D(LCD_COLOR * pColor, void * pIndex, U32 NumItems, U8 SizeOfIndex) { \
  DMA_Color2IndexBulk(pColor, pIndex, NumItems, SizeOfIndex, PIXELFORMAT);                                    \
}                                                                                                              \
static void Index2ColorBulk_##PFIX##_DMA2D(void * pIndex, LCD_COLOR * pColor, U32 NumItems, U8 SizeOfIndex) { \
  DMA_Index2ColorBulk(pColor, pIndex, NumItems, SizeOfIndex, PIXELFORMAT);                                    \
}

// 函数声明
static void DMA_Index2ColorBulk(void * pIndex, LCD_COLOR * pColor, U32 NumItems, U8 SizeOfIndex, U32 PixelFormat);
static void DMA_Color2IndexBulk(LCD_COLOR * pColor, void * pIndex, U32 NumItems, U8 SizeOfIndex, U32 PixelFormat);
...
static void LCD_LL_Init( void )
{
    ...
    DMA2D_Handler.Init.ColorMode = DMA2D_RGB888; //RGB565模式
