...
enum
{
	LCD_43_480x272 = 0,	// 4.3寸 480 * 272   0X4342 4.3寸屏,480*272分辨率
	LCD_70_800x480,		// 7.0寸 800 * 480   0X7084 7寸屏,800*480分辨率	
	LCD_70_1024x600,	// 7.0寸 1024 * 600  0X7016 7寸屏,1024*600分辨率
	LCD_70_1280x800,	// 7.0寸 1280 * 800  0X7018 7寸屏,1280*800分辨率
	LCD_80_1024x768,	// 7.0寸 1024 * 768  0X8017 8寸屏,1024*768分辨率	
};
