...
#ifndef __BSP_DRIVER_LTDC_H
#define __BSP_DRIVER_LTDC_H
...
#define LCD_BACK_LED(n)	(n ? HAL_GPIO_WritePin(LCD_BL_PORT, LCD_BL_PIN, GPIO_PIN_SET) : HAL_GPIO_WritePin(LCD_BL_PORT, LCD_BL_PIN, GPIO_PIN_RESET))   //LCD背光PD13              //LCD背光PD13
