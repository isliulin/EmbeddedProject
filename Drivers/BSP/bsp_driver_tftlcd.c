/**
  ...
  * @version 
  * @date    
  * @brief   2.8寸/3.5寸/4.3寸/7寸 TFT液晶驱动,支持驱动IC型号包括:ILI9341/NT35310/NT35510/SSD1963等
  ******************************************************************************
  * @history
//升级说明
//V1.1
...
//extern SRAM_HandleTypeDef sramHandle;     //SRAM句柄(用于控制LCD)
...
void BSP_TFTLCD_Init( void )
{
    ...
    LCD_BACK_LED( 1 ); //LCD_LED_ON();	 //点亮背光
    LCD_Clear( WHITE );
}
